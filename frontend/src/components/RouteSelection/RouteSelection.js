...
import RouteSelector_Metro from '../routeSelector/Routeselector_Metro'
        ...
        <div className="container">
            ...
            <div>
                <ul className="nav nav-pills">
                    ...
                    {/* <li className="nav-item">
                        <a className="nav-link" data-toggle="pill" href="#menu3">Metro</a>
                    </li> */}
                </ul>
                ...
                <div className="tab-content">
                    ...
                    {/* <div className="tab-pane container fade mn-box" id="menu3"><RouteSelector_Metro /></div> */}
                </div>
            </div>
